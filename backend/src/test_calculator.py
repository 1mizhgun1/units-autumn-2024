...
class TestCalculator(unittest.TestCase):
    ...
    def test_addition_inf(self):
        ...
        self.assertEqual(self.calculator.addition(float('-inf'), float('-inf')), float('-inf'))
        self.assertIsNone(self.calculator.addition(float('inf'), float('-inf')))
    ...
    def test_multiplication_inf(self):
        ...
        self.assertEqual(self.calculator.multiplication(float('inf'), -1), float('-inf'))
        self.assertEqual(self.calculator.multiplication(-1, float('-inf')), float('inf'))
        self.assertIsNone(self.calculator.multiplication(float('-inf'), 0))
        self.assertIsNone(self.calculator.multiplication(0, float('-inf')))
    ...
    def test_subtraction(self):
        ...
        self.assertAlmostEqual(self.calculator.subtraction(2/3, 1/6), 1/2)
    ...
    def test_subtraction_inf(self):
        self.assertIsNone(self.calculator.subtraction(float('inf'), float('inf')))
        self.assertIsNone(self.calculator.subtraction(float('-inf'), float('-inf')))
    ...
    def test_division(self):
        ...
        self.assertAlmostEqual(self.calculator.division(2, 6), 1/3)
    ...
    def test_division_inf(self):
        ...
        self.assertIsNone(self.calculator.division(float('inf'), float('inf')))
        self.assertIsNone(self.calculator.division(float('-inf'), float('-inf')))
        self.assertIsNone(self.calculator.division(float('inf'), float('-inf')))
        self.assertIsNone(self.calculator.division(float('-inf'), float('inf')))
